...
export function Nav() {
  return (
    <nav className="relative z-50 flex items-center justify-between gap-6 px-5 py-7 md:px-16 flex-wrap">
      ...
      <div className="flex items-center gap-2 md:gap-6 text-nav text-muted-foreground">
      ...
      <a href="#agendar" className="p-3 text-nav text-primary border-b border-muted-text pb-1 hover:border-primary transition-colors min-h-[44px] flex items-center">
        AGENDAR LLAMADA →
      </a>
    </nav>
  );
